        ...
        'audio': function (context) {
            ...
            this.initialize = function () {
                ...
                var body = [
                    ...
                    '<label class="note-form-label">' + lang.audio.url + ' <small>(only MP3 or OGG audio file url)</small> </label>',
            ...
            this.createAudio = function (url) {
                ...
                var mpegRegExp = /^.+.(mpeg)$/;
                var mpegMatch = url.match(mpegRegExp);
                ...
                var $audio;
                if (mp3Match || mpegMatch || oggMatch || base64Match) {
