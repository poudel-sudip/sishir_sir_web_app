    ...
    <div class="student-content-wrapper chatroom-section content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-12 my-3 chatroom-header" style="font-size: 0.75rem !important; text-align:right">
                <a href="/classroom/files/{{$batch->id}}" class="nav-link ">Unit Wise Files</a>
                <a href="/classroom/files/{{$batch->id}}/all" class="nav-link active">All Files</a>
            </div>
        </div>

        <div class="row chatroom-main-content mt-4">
            <div class="col-12 mx-5 my-3 h5">All Files</div>
            @if(auth()->user()->role!='Student')
            ...
            @endif
            @forelse($batch->classFiles as $files)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select name="file_unit" id="file_unit" class="form-control @error('file_unit') is-invalid @enderror">
                                        <option value="">Select File Unit</option>
