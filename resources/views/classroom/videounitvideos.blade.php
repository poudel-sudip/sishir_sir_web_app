      ...
      <div class="modal-content">
        ...
        <div class="modal-body enroll_form">
            <div class="row">
                <div class="col-md-12">
                    @if(auth()->user()->role!='Student')
                        <form method="POST" action="/classroom/videos/{{$batch->id}}/unit/{{$unit->id}}" enctype="multipart/form-data">
                            @csrf

                            <div class="form-group row">
                                <label for="unit" class="col-md-3 col-form-label text-md-right">{{ __(' Unit Name') }}</label>

                                <div class="col-md-9">
                                    <input id="unit" type="text" class="form-control @error('unit') is-invalid @enderror" name="unit" value="{{ $unit->name }}"  readonly>
