...
@section('admin-title')
    Admin Forms Applicants Followup
@endsection

@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Admin Form Applicants Followup</h3>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('/team/followup/pending/admin-forms') }}">Admin Forms</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="card-title text-center h4">Pending Followups | {{ucwords($assign->category->name)}}</div>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="/team/followup/pending/admin-forms/{{$assign->id}}/applicants/add" enctype="multipart/form-data">
                    @csrf
