...
@section('content')
  <div class="content-wrapper pb-0">
    <div class="page-header">
      <h3 class="page-title">Pending Followups</h3>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{ url('/team/home') }}">Dashboard</a></li>
          <li class="breadcrumb-item active" aria-current="page">Pending Followups</li>
        </ol>
      </nav>
    </div>  
                ...
                <div class="card bg-info">
                  <div class="card-body px-3 py-4">
                    <div class="color-card text-center">
                      ...
                      <a class="btn btn-warning rounded" href="/team/followup/pending/registered-users">View</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card bg-success">
                  <div class="card-body px-3 py-4">
                    <div class="color-card text-center">
                      ...
                      <a class="btn btn-warning rounded" href="/team/followup/pending/admin-forms">View</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card bg-info">
                  <div class="card-body px-3 py-4">
                    <div class="color-card text-center">
                      ...
                      <a class="btn btn-warning rounded" href="/team/followup/pending/vendor-forms">View</a>
                    </div>
                  </div>
                </div>
              </div>
