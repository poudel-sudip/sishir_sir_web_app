...
@section('admin-title')
    Followed Vendor Forms Followups
@endsection

@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Followed Vendor Forms Applicants</h3>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('/team/followup/followed/vendor-forms') }}">Vendor Forms</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title text-center h4">
                          Followed Followups | {{ucwords($assign->form->title)}}
                        </div>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="classroom-btn" width="100">
                                  <a href="/team/followup/followed/vendor-forms/{{$assign->id}}/applicants/{{$data->id}}" class="btn btn-info">Show</a>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="/team/followup/followed/vendor-forms/{{$assign->id}}/applicants/update" enctype="multipart/form-data">
                    @csrf
