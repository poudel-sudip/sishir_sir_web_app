...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Followed Vendor Forms Followup Lists</h3>
                            ...
                            <table class="table table-bordered" id="advanced-desc-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="classroom-btn" width="100"> <a href="/team/followup/followed/vendor-forms/{{$data->id}}/applicants" class="btn btn-info"> View Followed</a> </td>
                                    </tr>
                                    @php($i++)
                                @endforeach
                                </tbody>                         
