...
@section('admin-title')
    Show Vendor Form Applicant Followup
@endsection

@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Show Vendor Form Applicant Followup</h3>
            <nav aria-label="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="{{ url('/team/followup/followed/vendor-forms/'.$assign->id.'/applicants') }}">Applicants</a></li>
