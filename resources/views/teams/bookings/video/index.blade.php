                    ...
                    <div class="card-body">
                      <div class="custon-table-header">
                          ...
                          <div class="text-right">
                              <a href="{{ ('/team/video-bookings/create') }}"><button type="button" class="btn btn-sm ml-3 btn-success"> Add Booking </button></a>
                          </div>
                      </div>
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td class="classroom-btn" width="150">
                                    <a href="/team/video-bookings/{{$booking->id}}" class="btn btn-primary">Show</a>
                                    <a href="/team/video-bookings/{{$booking->id}}/edit" class="btn btn-warning">Edit</a>
                                    @if((!isset($booking->booking->status)) || (isset($booking->booking->status) && $booking->booking->status != 'Verified'))
                                    <form id="delete-form-{{$booking->id}}" action="/team/video-bookings/{{$booking->id}}" method="POST" style="display: inline">
                                        @csrf
                                        @method('DELETE')
