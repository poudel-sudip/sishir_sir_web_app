...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Latest 300 E-Book Bookings</h3>
                ...
                <div class="card">
                    <div class="card-body">
                      <div class="custon-table-header">
                          <h4 class="card-title">Latest 300 E-Book Bookings</h4>
                          <div class="text-right">
                              <a href="{{ ('/team/ebook-bookings/create') }}"><button type="button" class="btn btn-sm ml-3 btn-success"> Add Booking </button></a>
                          </div>
                      </div>
                        ...
                        <table class="table table-bordered" id="advanced-desc-table">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-wrap">{{ucwords($booking->booking->book->title ?? '')}}</td>
                                ...
                                <td class="classroom-btn" width="150">
                                    <a href="/team/ebook-bookings/{{$booking->id}}" class="btn btn-primary">Show</a>
                                    <a href="/team/ebook-bookings/{{$booking->id}}/edit" class="btn btn-warning">Edit</a>
                                    @if((!isset($booking->booking->status)) || (isset($booking->booking->status) && $booking->booking->status != 'Verified'))
                                    <form id="delete-form-{{$booking->id}}" action="/team/ebook-bookings/{{$booking->id}}" method="POST" style="display: inline">
                                        @csrf
                                        @method('DELETE')
