                    ...
                    <div class="card-body">
                        <div class="custon-table-header">
                            ...
                            <div class="text-right">
                                <a href="{{ ('/team/users/create') }}"><button type="button" class="btn btn-sm ml-3 btn-success"> Add User </button></a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="classroom-btn" width="160">
                                            <a href="/team/users/{{$user->id}}" class="btn btn-primary">Show</a>
                                            <a href="/team/users/{{$user->id}}/edit" class="btn btn-danger">Edit</a>
                                            ...
                                            <form id="delete-form-{{$user->id}}" action="/team/users/{{$user->id}}" method="POST" style="display: inline">
                                                @csrf
                                                @method('DELETE')
