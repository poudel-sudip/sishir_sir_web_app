    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="auth-container auth-register">
                ...
                <div class="card">
                    <div class="card-header bg-transparent">{{ __('Register As Tutor') }}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register.tutor') }}">
                            ...
                            <div class="form-group row">
                                <label for="qualification" class="col-md-6 col-form-label">{{ __('Qualification') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="experience" class="col-md-6 col-form-label">{{ __('Experience') }}</label>
