...
<div class="student-content-wrapper chatroom-section content-wrapper" oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
    ...
    <div class="border messanger-section" style="overflow: hidden; overflow-y:scroll;">
        ...
        <div class="chat">
            <div class="messages" id="chat">
                @forelse ($chats as $chat)
                    @if($chat->from==auth()->user()->name)
                    <div class="user-name-time">
                        <span>{{$chat->from}} to {{$chat->to}} on {!! date('d-M-y g:ia',strtotime($chat->created_at)) !!}</span>
                    </div>
            ...
            <div class="your-message">
                <form method="POST" class="mb-n2" action="/student/messenger/{{$booking->id}}/chat" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
