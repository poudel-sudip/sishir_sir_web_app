...
@section('content')
    ...
    <div class="student-content-wrapper student-enroll-section bg-white">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="owl-carousel chapter-file-carousel" id="chapterfiles">
                ...
                <iframe id="pdfiframe" src="/storage/{{$chapter->pdf_file}}#toolbar=0&navpanes=0" frameBorder="0" scrolling="auto" height="600" width="100%"> </iframe>
