            ...
            <div class="col-md-8">
                <div class="card student_verify_card">
                    ...
                    <div class="card-body enroll_form">
                        <form id="verifyCourseForm" method="POST" action="/student/ebook-bookings/{{$booking->id}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <a href="{{ url('/student/ebook-bookings') }}" class="btn btn-secondary">Verify Later</a>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
      ...
      function pay_esewa()
      {
        ...
        var params= {
            ...
            su: '{{url("student/ebook-bookings/$booking->id/esewaSuccess")}}',
            fu: '{{url("student/ebook-bookings/$booking->id/payment-failed")}}'
        };
    ...
    <script>
        function pay_khalti()
        {
            var config = {
                ...
                "productUrl": "{{url('student/ebook-bookings')}}",
                "paymentPreference": [
                    "KHALTI",
                    "EBANKING",
                    "MOBILE_BANKING",
                ...
                "eventHandler": {
                    onSuccess (payload) {
                        ...
                        if(payload.idx)
                        {
                            ...
                            $.ajax({
                                method: 'POST',
                                url: '{{url("student/ebook-bookings/$booking->id/khaltiSuccess")}}',
                                data: payload,
                                ...
                                success: function(response) {
                                    ...
                                    {
                                        checkout.hide();
                                        window.location = '{{url("student/ebook-bookings/$booking->id/payment-failed")}}';
                                    }
                                },
