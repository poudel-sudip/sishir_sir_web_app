                    ...
                    <div class="col-md-12">
                        <div class="public-question-list">
                            ...
                            <div class="public-question-body">
                                <form action="/student/course-bookings/{{$booking->id}}/mcq-exams/{{$exam->id}}/save" method="POST" id="exam-form">
                                    @csrf
                                    @php
                                        $pages = $exam->questions->chunk(1); // Split into pages
                                        $key = -1;
                                    @endphp
    ...
    <script type="text/javascript">
        ...
        {           
            ...
            Swal.fire({
                ...
                {
                    window.location.href = '/student/course-bookings/{{$booking->id}}/mcq-exams';
                }
                else
                {
                    // alert('cancncelled'); 
