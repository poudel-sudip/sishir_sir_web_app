            ...
            <div class="col-md-12">
                <div class="card student_exam_card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/student/classroom/exams/{{$batch->id}}/mcq-exams/{{$exam->id}}/result" method="POST" id="exam-form">
                            @csrf
                            ...
                            <div class="mcq-question-list row">
                                ...
                                {{-- <ol class="ul-list"  style="list-style-type: lower-alpha;" >
                                    <li><input type="radio" name="ans-{{$key+1}}" value="{{$ques->opt_a}}" id="ans-{{$key+1}}-1" /> <label for="ans-{{$key+1}}-1"> {{$ques->opt_a}} </label>  </li>
                                    <li><input type="radio" name="ans-{{$key+1}}" value="{{$ques->opt_b}}" id="ans-{{$key+1}}-2" /> <label for="ans-{{$key+1}}-2"> {{$ques->opt_b}} </label>  </li>
                                    <li><input type="radio" name="ans-{{$key+1}}" value="{{$ques->opt_c}}" id="ans-{{$key+1}}-3" /> <label for="ans-{{$key+1}}-3"> {{$ques->opt_c}} </label>  </li>
                                    <li><input type="radio" name="ans-{{$key+1}}" value="{{$ques->opt_d}}" id="ans-{{$key+1}}-4" /> <label for="ans-{{$key+1}}-4"> {{$ques->opt_d}} </label>  </li>
                                </ol> --}}
                            @endforeach
                            </div>
