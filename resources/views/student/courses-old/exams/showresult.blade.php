        ...
        <div class="row">
            <div class="col-md-12">
                <div class="view-evaluation"> 
                    ...
                    <div class="h6 text-center mb-4">{{$exam->name}}</div>
                ...
                <div class="answer-details">
                    ...
                    {{-- <ol>
                        ...
                        <li class="my-2">
                            {{$ans->question}}
                            <br>
                            Correct Answer: <span class="icon-checkbox-checked text-success"></span> {{$ans->correct_ans}} <br>
                            Your Answer: <i class="fa fa-comment text-primary" aria-hidden="true"></i> {{$ans->your_ans}}
                        </li>
