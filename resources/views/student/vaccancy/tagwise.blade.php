                    ...
                    <div class="swiper category-swiper nav nav-tabs">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="/student/vaccancies"> <button class="nav-link border">All</button> </a>
                            </div>
                            @foreach($tag_categories as $tag)
                                <div class="swiper-slide">
                                    <a href="/student/vaccancies-tag/{{$tag->id}}"> <button class="nav-link border {{$tag->id == $selected_tag->id ? 'active' : ''}} ">{{$tag->name}}</button> </a>
                                </div>
                            @endforeach
                        </div>
                    </div>
