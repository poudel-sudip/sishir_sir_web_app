...
@section('student-title')
    Common Question Collections or Queries of {{$course->name}}
@endsection
...
<div class="student-content-wrapper">
    <div class="card p-3">
        <div class="card-title">
            <div class="h4 text-center">{{$course->name}} | CQQ</div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <hr>
            <form method="POST" action="/student/video-course/{{$booking->id}}/cqc" enctype="multipart/form-data">
                @csrf
