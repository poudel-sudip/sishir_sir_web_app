                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ ('/moderator/exams') }}" enctype="multipart/form-data" class="forms-sample">
                            ...
                            <div class="form-group row">
                                <label for="category" class="col-md-4 col-form-label">{{ __('Exam Category') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label">{{ __('Exam Name') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="date" class="col-md-4 col-form-label">{{ __('Exam Date') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="time" class="col-md-4 col-form-label">{{ __('Exam Time') }} </label>
                            ...
                            <div class="form-group row">
                                <label for="marks" class="col-md-4 col-form-label">{{ __('Marks Per Question') }} </label>
                            ...
                            <div class="form-group row">
                                <label for="negativeMarks" class="col-md-4 col-form-label">{{ __('Negative Marks Per Question') }} </label>
                            ...
                            <div class="form-group row">
                                <label for="answer_video" class="col-md-4 col-form-label">{{ __('Solution Video') }} </label>
                            ...
                            <div class="form-group row">
                                <label for="answer_pdf" class="col-md-4 col-form-label">{{ __('Solution PDF') }} </label>
                            ...
                            <div class="form-group row">
                                <label for="status" class="col-md-4 col-form-label">{{ __('Exam Status') }}</label>
