        ...
        <div class="row justify-content-center">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ ('/moderator/exams') }}" enctype="multipart/form-data" class="forms-sample">
                            @csrf
                                ...
                                <div class="col-md-9 row">
                                    <div class="col-sm-4">
                                        <div class="form-check">
                                            ...
                                            <input id="pdf_view_1" type="radio" class="form-check-input" name="pdf_view" value="1" >Enabled</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                            <input id="pdf_view_2" type="radio" class="form-check-input" name="pdf_view" value="0" checked>Disabled</label>
                                        </div>
                                    </div>
                                    @error('pdf_view')
                                    <span class="invalid-feedback" role="alert">
