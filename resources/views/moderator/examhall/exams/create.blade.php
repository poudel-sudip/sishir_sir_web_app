    ...
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('/moderator/exam-hall') }}">Exam Hall</a></li>
                <li class="breadcrumb-item"><a href="/moderator/exam-hall/{{$category->id}}/exams">Exams</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/moderator/exam-hall/{{$category->id}}/exams" enctype="multipart/form-data" class="forms-sample">
                            @csrf
    ...
    <script>
        $(document).ready(function () {
            ...
            function get_exams(id)
            {
                ...
                request.open('GET', '/moderator/exam-category/'+id+'/getexams', true)
