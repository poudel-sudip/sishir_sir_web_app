                    ...
                    <div class="card-body">
                      <div class="custon-table-header">
                          ...
                          <div class="text-right">
                            <a href="{{ ('/moderator/exam-hall/bookings/create') }}"><button type="button" class="btn btn-sm ml-3 btn-primary"> Create Exam Booking </button></a>
                           </div>
                      </div>
                        ...
                        <table class="table table-bordered" id="advanced-desc-table">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>Rs. {{ $booking->paymentAmount ?? '0'}}</td>
                                <td>Rs. {{ $booking->discount ?? '0'}}</td>
                                <td>
                                    @if($booking->status == 'Verified' && $booking->dueAmount>5)
