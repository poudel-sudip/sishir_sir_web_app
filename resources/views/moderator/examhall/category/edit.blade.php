    ...
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('/moderator/exam-hall') }}">Exam Sets</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/moderator/exam-hall/{{$category->id }}" enctype="multipart/form-data" class="forms-sample">
                            @csrf
                            @method('PATCH')
                            <div class="form-group row">
                                <label for="categoryID" class="col-md-4 col-form-label">{{ __('Exam Set ID') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="price" class="col-md-4 col-form-label">{{ __('Exam Set Price') }} </label>
                            ...
                            <div class="form-group row">
                                <label for="discount" class="col-md-4 col-form-label">{{ __('Exam Set Discount') }} </label>
                            ...
                            <div class="form-group row">
                                <label for="status" class="col-md-4 col-form-label">{{ __('Exam Set Status') }}</label>
