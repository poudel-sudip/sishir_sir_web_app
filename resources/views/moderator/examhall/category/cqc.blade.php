...
@section('content')
    <div class="content-wrapper">
                                ...
                                @foreach($category->cqcs as $cqc)
                                    <tr>
                                        ...
                                        <td class="classroom-btn" width="50">
                                            <form id="delete-form-{{$cqc->id}}" action="/moderator/exam-hall/{{$category->id}}/cqc/{{$cqc->id}}" method="POST" style="display: inline">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="row">
            <div class="col-md-12">
                <hr>
                <form method="POST" action="/moderator/exam-hall/{{$category->id}}/cqc" enctype="multipart/form-data">
                    @csrf
