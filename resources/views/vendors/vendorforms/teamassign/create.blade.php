    ...
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/vendor/vendor-dynamic-forms/{{$vform->id}}/team-assign">Team Assigns</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-header">Assign Team | {{$vform->title}}</div>
                    <div class="card-body">
                    <form class="forms-sample" method="POST" action="/vendor/vendor-dynamic-forms/{{$vform->id}}/team-assign" enctype="multipart/form-data">
                        @csrf
