        ...
        <div class="row justify-content-center">
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form class="forms-sample" method="POST" action="/vendor/vendor-dynamic-forms" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="form_title" type="text" class="form-control @error('form_title') is-invalid @enderror" name="form_title" value="{{ old('form_title') }}"  autocomplete="form_title" required>
                                @error('form_title')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            <label for="sub_categories" class="col-md-4 col-form-label">{{ __('Form Sub Categories') }}</label>
                            <div class="col-md-8">
                                <textarea name="sub_categories" id="sub_categories" rows="3" class="form-control @error('sub_categories') is-invalid @enderror">{{ old('sub_categories') }}</textarea>
