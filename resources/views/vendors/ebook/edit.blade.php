        ...
        <div class="row justify-content-center">
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/vendor/ebook-booking/{{$vendorbooking->id}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="book" type="text" class="form-control @error('book') is-invalid @enderror" name="book" value="{{ old('book') ?? ($booking->book->title ?? '')  }}" readonly>
