                    ...
                    <div class="card-body">
                      <div class="custon-table-header">
                          ...
                          <div class="text-right">
                              <a href="{{ ('/vendor/ebook-booking/create') }}"><button type="button" class="btn btn-sm ml-3 btn-success"> Add Booking </button></a>
                          </div>
                      </div>
                        ...
                        <table class="table table-bordered" id="main-booking-table">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-wrap">{{$booking->booking->book->title ?? ''}}</td>
                                ...
                                <td class="classroom-btn" width="150">
                                    <a href="/vendor/ebook-booking/{{$booking->id}}" class="btn btn-primary">Show</a>
                                    <a href="/vendor/ebook-booking/{{$booking->id}}/edit" class="btn btn-danger">Edit</a>
                                    @if((!isset($booking->booking->status)) || (isset($booking->booking->status) && $booking->booking->status != 'Verified'))
                                    <form id="delete-form-{{$booking->id}}" action="/vendor/ebook-booking/{{$booking->id}}" method="POST" style="display: inline">
                                        @csrf
                                        @method('DELETE')
