...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">All Exam Bookings</h3>
                ...
                <div class="card">
                    <div class="card-body">
                      <div class="custon-table-header">
                          <h4 class="card-title">All Exam Bookings</h4>
                          <div class="text-right">
                              <a href="{{ ('/vendor/exam-hall/bookings/create') }}"><button type="button" class="btn btn-sm ml-3 btn-success"> Add Booking </button></a>
                          </div>
                      </div>
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td class="classroom-btn" width="150">
                                    <a href="/vendor/exam-hall/bookings/{{$booking->id}}" class="btn btn-primary">Show</a>
                                    <a href="/vendor/exam-hall/bookings/{{$booking->id}}/edit" class="btn btn-danger">Edit</a>
                                    @if((!isset($booking->booking->status)) || (isset($booking->booking->status) && $booking->booking->status != 'Verified'))
                                    <form id="delete-form-{{$booking->id}}" action="/vendor/exam-hall/bookings/{{$booking->id}}" method="POST" style="display: inline">
                                        @csrf
                                        @method('DELETE')
