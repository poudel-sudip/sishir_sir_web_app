...
@section('admin-title')
   {{$category->name}} | Edit Links
@endsection

@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">{{$category->name}} | Edit Links</h3>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="forms-sample" method="POST" action="/admin/imp-links/{{$category->id}}/links/{{$link->id}}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
