                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="custon-table-header">
                            <h4 class="card-title">All Followup Followed Users</h4>
                            <div class="text-right">
                                    <a href="/admin/batch/{{$batch->id}}/followup/followed/download"><button type="button" class="btn btn-sm ml-3 btn-success"> Download </button></a>
                            </div>                           
                        </div>
