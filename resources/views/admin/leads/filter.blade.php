    ...
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('/leads/enquiries') }}">Enquiries</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="/leads/enquiries/filter" enctype="multipart/form-data">
                            @csrf
        ...
        <div class="row mt-5">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-center">Leads/Enquiries of : {{$filterValue ?? ''}}</h4>
