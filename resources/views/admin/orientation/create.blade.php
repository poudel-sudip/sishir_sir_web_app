...
@section('admin-title')
    Create Orientation Class
@endsection

@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Create Free Orientation Class</h3>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-header">Create Free Orientation Class</div>
                    <div class="card-body">
                        <form method="POST" action="{{ ('/admin/orientations') }}" enctype="multipart/form-data" class="forms-sample">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="join_link" type="text" class="form-control @error('join_link') is-invalid @enderror" name="join_link" value="{{ old('join_link') }}"  autocomplete="join_link" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <textarea id="description" class="form-control summernote @error('description') is-invalid @enderror" name="description" >{!! old('description') !!}</textarea>
