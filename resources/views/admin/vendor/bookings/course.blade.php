...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Vendor Course Bookings</h3>
                ...
                <div class="card">
                    <div class="card-body">
                      <div class="custon-table-header">
                          <h4 class="card-title">{{$vendor->name}} | Course Bookings</h4>
                      </div>
                        ...
                        <table class="table table-bordered" id="main-booking-table">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$booking->booking->batch->name ?? ''}}</td>
                                ...
                                {{-- <td class="classroom-btn" width="150">
                                    <a href="/admin/bookings/{{$booking->booking->id}}" class="btn btn-primary">Show</a>
                                    @if(auth()->user()->permission>=40)
                                    <a href="/admin/bookings/{{$booking->booking->id}}/edit" class="btn btn-danger">Edit</a>
                                    <form id="delete-form-{{$booking->booking->id}}" action="/admin/bookings/{{$booking->booking->id}}" method="POST" style="display: inline">
                                        @csrf
                                        @method('DELETE')
                                        <a href="javascript:{}" onclick="javascript:deleteData({{$booking->booking->id}});" class="btn btn-warning">Delete</a>
                                    </form>
                                    @endif
                                </td> --}}
                            </tr>
