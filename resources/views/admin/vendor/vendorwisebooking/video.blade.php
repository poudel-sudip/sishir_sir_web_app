...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Vendor Wise Video Bookings</h3>
                ...
                <div class="card">
                    <div class="card-body">
                      <div class="custon-table-header">
                          <h4 class="card-title">Vendor Wise Video Bookings</h4>
                      </div>
                        ...
                        <table class="table table-bordered" id="main-booking-table">
                          <thead>
                            <tr>
                                ...
                                <th class="text-wrap">Video Course</th>
