                    ...
                    <div class="card-body">
                        <form method="POST" action="/admin/exams/{{$exam->id}}/questions" enctype="multipart/form-data" class="forms-sample">
                            ...
                            <div class="form-group row align-items-center">
                                <label for="question" class="col-md-2 col-form-label "> <strong>{{ __('Question') }}</strong> </label>
                            ...
                            <div class="form-group row align-items-center">
                                <label for="optionA" class="col-md-2 col-form-label"><strong>{{ __('Option A') }}</strong></label>
                            ...
                            <div class="form-group row align-items-center">
                                <label for="optionB" class="col-md-2 col-form-label "><strong>{{ __('Option B') }}</strong></label>
                            ...
                            <div class="form-group row align-items-center">
                                <label for="optionC" class="col-md-2 col-form-label "><strong>{{ __('Option C') }}</strong></label>
                            ...
                            <div class="form-group row align-items-center">
                                <label for="optionD" class="col-md-2 col-form-label"><strong>{{ __('Option D') }}</strong></label>
                            ...
                            <div class="form-group row">
                                <label for="optionCorrect" class="col-md-2 col-form-label"><strong>{{ __('Correct Answer') }}</strong></label>
                            ...
                            <div class="form-group row align-items-center">
                                <label for="rationale" class="col-md-2 col-form-label"><strong>{{ __('Rationale / Justification') }}</strong></label>
