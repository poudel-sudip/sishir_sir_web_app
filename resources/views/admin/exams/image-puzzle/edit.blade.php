...
@section('admin-title')
    Edit Image Puzzle Question
@endsection

@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Edit Image Puzzle Question</h3>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-header">Edit Image Puzzle Question</div>
                    <div class="card-body">
                        <form method="POST" action="/admin/play-puzzle/image/{{$question->id}}" enctype="multipart/form-data" class="forms-sample">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-md-8">
                                    <input id="question" type="file" class="form-control @error('question') is-invalid @enderror" name="question" value="{{ old('question') }}" autocomplete="question" accept="image/*">
