...
@section('admin-title')
    Add Image Puzzle Question
@endsection

@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Add Image Puzzle Question</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/admin/home') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ url('/admin/play-puzzle/image') }}">Play Image Puzzles</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-header">Add Image Puzzle Question</div>
                    <div class="card-body">
                        <form method="POST" action="/admin/play-puzzle/image" enctype="multipart/form-data" class="forms-sample">
                            @csrf
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-md-8">
                                    <input id="question" type="file" class="form-control @error('question') is-invalid @enderror" name="question" value="{{ old('question') }}" autocomplete="question" required autofocus accept="image/*">
