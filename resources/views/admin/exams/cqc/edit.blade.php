...
@section('admin-title')
    Edit Exam CQC Content
@endsection

@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Edit Exam CQC</h3>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-header">Update Exam CQC Content</div>
                    <div class="card-body">
                        <form method="POST" action="/admin/exams/{{$exam->id}}/cqcs/{{$cqc->id}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
