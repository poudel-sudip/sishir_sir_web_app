                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ ('/admin/careers/'.$vaccancy->id) }}" enctype="multipart/form-data" class="forms-sample">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <textarea id="description" class="form-control summernote @error('description') is-invalid @enderror" name="description" >{!! old('description') ?? $vaccancy->description !!}</textarea>
                                    ...
                                    @foreach($tags as $tag)
                                        <div class="d-inline-block text-center border">
                                            <input 
                                                ...
                                                id="tag_{{ $tag->id }}" 
                                                value="{{ $tag->id }}"
                                                {{ ((is_array(old('related_tags')) && in_array($tag->id, old('related_tags'))) || (in_array($tag->id,$vaccancy->tag_ids))) ? 'checked' : '' }}
                                            >
