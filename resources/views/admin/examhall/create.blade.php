...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Create New Exam Category</h3>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-header">Add Exam Category</div>
                    <div class="card-body">
                        <form method="POST" action="{{ ('/admin/exam-hall') }}" enctype="multipart/form-data" class="forms-sample">
                            ...
                            <div class="form-group row">
                                <label for="image" class="col-md-5 col-form-label">{{ __(' Image') }}</label>
                                <div class="col-md-7">
