                    ...
                    <div class="card-body">
                        <div class="custon-table-header">
                          ...
                          <div class="text-right">
                            <a href="{{ ('/admin/exam-hall/bookings/create?page_type=group') }}"><button type="button" class="btn btn-sm ml-3 btn-success"> Create Exam Booking </button></a>
                           </div>
                        </div>
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td class="classroom-btn" width="150">
                                    ...
                                    <a href="/admin/exam-hall/bookings/{{$booking->id}}/edit?page_type=group" class="btn btn-danger">Edit</a>
                                    <form id="delete-form-{{$booking->id}}" action="/admin/exam-hall/bookings/{{$booking->id}}?page_type=group" method="POST" style="display: inline">
                                        @csrf
                                        @method('DELETE')
