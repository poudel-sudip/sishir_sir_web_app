                    ...
                    <div class="card-body">
                      <div class="custon-table-header">
                          ...
                          <div class="text-right">
                            <a href="{{ ('/admin/vendor-exam-bookings') }}"><button type="button" class="btn btn-sm ml-3 btn-info"> Vendor Bookings </button></a>
                            <a href="{{ ('/admin/exam-hall/bookings/create') }}"><button type="button" class="btn btn-sm ml-3 btn-primary"> Create Exam Booking </button></a>
                           </div>
                      </div>
