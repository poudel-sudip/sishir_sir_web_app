...
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">Course Reports</h3>
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                ...
                <ul class="list-ticked">
                    <li>Course Reports <a href="/admin/reports/course/all" class="btn btn-warning">Generate</a></li>
                </ul>
                </div>
            </div>
        </div>
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <li>{{$course->name}}<a href="/admin/reports/course/{{$course->id}}" class="btn btn-info">Generate</a></li>
                    @endforeach
                    </ul>
                </div>
            </div>
