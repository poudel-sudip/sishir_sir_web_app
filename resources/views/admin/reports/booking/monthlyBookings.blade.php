...
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">Monthly Bookings Report</h3>
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Generate(monthly)</li>
            </ol>
        </nav>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="custon-table-header">
                        <h4 class="card-title">{{ __('Monthly Booking For: ').date('Y-m',strtotime($date)) }}</h4>
                        <a href="/admin/reports/booking/monthly/{{$date}}/export">Download</a>
                    </div>
