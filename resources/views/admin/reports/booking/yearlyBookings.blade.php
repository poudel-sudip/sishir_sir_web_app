...
@section('admin-title')
    Yearly Bookings Report
@endsection
@section('content')
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">Yearly Bookings Report</h3>
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Generate(yearly)</li>
            </ol>
        </nav>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="custon-table-header">
                        <h4 class="card-title">{{ __('Yearly Booking Reports for: ').date('Y',strtotime($date)) }}</h4>
                        <a href="/admin/reports/booking/yearly/{{$date}}/export">Download</a>
                    </div>
