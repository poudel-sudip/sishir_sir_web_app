...
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">All Bookings Report</h3>
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Generate(all)</li>
            </ol>
        </nav>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="custon-table-header">
                        ...
                        <a href="/admin/reports/booking/all/export">Download</a>
                    </div>
