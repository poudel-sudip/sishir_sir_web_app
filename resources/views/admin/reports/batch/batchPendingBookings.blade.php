...
@section('admin-title')
    Pending Batch Booking
@endsection

@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Pending Batch Booking Reports</h3>
...
{{--                            <h4 class="card-title">{{ __('All Pending Bookings Report of Batch: ').$batch->name }}</h4>--}}
                            <a href="/admin/reports/batch/{{$batch->id}}/pending/export">Download</a>
                        </div>
                        <div class="report">
