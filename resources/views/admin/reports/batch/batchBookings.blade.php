...
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">All Batch Booking Reports</h3>
...
{{--                        <h4 class="card-title">{{ __('All Bookings Report of Batch: ').$batch->name }}</h4>--}}
                        <a href="/admin/reports/batch/{{$batch->id}}/all/export">Download</a>
                    </div>
                        <div class="report">
