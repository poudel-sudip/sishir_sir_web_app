...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">User Ticket Messages</h3>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/admin/home') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="/admin/user-tickets/{{$ticket->status ? 'open' : 'closed'}}">Tickets</a></li>
                        ...
                        <div class="container clearfix">    
                            <div class="forum-chat">
                                ...
                                <div class="chat-message clearfix">
                                    <form action="/admin/user-tickets/{{$ticket->id}}/contents" method="POST" enctype="multipart/form-data">
                                        @csrf()
                                        ...
                                        @enderror    
                                        <label for="post_image" class="mt-2 @error('post_image') is-invalid @enderror"><i class="fa fa-image"></i> Add Image</label>
                                        @error('post_image')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                            </span>
    ...
    <script type="text/javascript">
        function deleteMessage(id)
        {
            ...
            if (result.isConfirmed) {
                ...
                form.setAttribute("action", "/admin/user-tickets/{{$ticket->id}}/contents");
