...
@section('admin-title')
    Form Applicants | {{$group->name}}
@endsection

@section('content')
  <div class="content-wrapper">
    <div class="page-header">
      <h3 class="page-title">Form Applicants | {{$group->name}}</h3>
      <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ url('/admin/home') }}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ url('/admin/dynamic-forms/groups') }}">Form Groups</a></li>
            <li class="breadcrumb-item"><a href="/admin/dynamic-forms/groups/{{$group->id}}/forms">Forms</a></li>
        ...
        <div class="card">
          <div class="card-body">
            <div class="custon-table-header">
                <h4 class="card-title">Form Applicants | {{$group->name}} </h4>
            </div>
              ...
              <table class="table table-bordered" id="category-table">
                <thead>
                  <tr>
                    ...
                    <th class="text-wrap">Followed By</th>
                    <th>Action</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="classroom-btn" width="75">
                      <a href="/admin/dynamic-forms/categories/{{$row->category_id}}/applicants/{{$row->id}}" class="btn btn-info">Show</a>
                      <form id="delete-form-{{$row->id}}" action="/admin/dynamic-forms/categories/{{$row->category_id}}/applicants/{{$row->id}}" method="POST" style="display: inline">
                        @csrf
                        @method('DELETE')
