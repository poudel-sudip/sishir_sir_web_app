                      ...
                      <table class="table table-bordered" id="category-table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="/admin/dynamic-forms/groups/{{$cat->id}}/forms"> Forms ( {{$cat->categories->count()}} ) </a></td>
                            <td><a href="/admin/dynamic-forms/groups/{{$cat->id}}/applicants"> Applicants ( {{$cat->applicants->count()}} ) </a></td>
                            <td class="classroom-btn" width="175">
                              ...
                              <form id="delete-form-{{$cat->id}}" action="/admin/dynamic-forms/groups/{{$cat->id}}" method="POST" style="display: inline">
                                    @csrf
                                    @method('DELETE')
      ...
      <div class="modal-dialog ">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  <form method="POST" action="/admin/dynamic-forms/groups" enctype="multipart/form-data">
                      @csrf
