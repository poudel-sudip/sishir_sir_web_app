...
@section('admin-title')
    Dynamic Form Assigned to Team
@endsection

@section('content')
    <div class="content-wrapper">
        <div class="page-header">
        <h3 class="page-title"> Team Assigns | {{$category->name}}</h3>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="custon-table-header">
                        <h4 class="card-title"> Team Assigns | {{$category->name}} </h4>
                        <div class="text-right">
                            <a href="/admin/dynamic-forms/categories/{{$category->id}}/team-assign/create"><button type="button" class="btn btn-sm ml-3 btn-success"> Assign Team </button></a>
                        </div>
                    </div>
                      ...
                      <table class="table table-bordered" id="category-table">
                        <thead>
                          <tr>
                            ...
                            <th>Date</th>
                            <th>Team</th>
                            <th class="texy-wrap">Category</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="classroom-btn" width="75">
                              <form id="delete-form-{{$data->id}}" action="/admin/dynamic-forms/categories/{{$category->id}}/team-assign/{{$data->id}}" method="POST" style="display: inline">
                                    @csrf
                                    @method('DELETE')
