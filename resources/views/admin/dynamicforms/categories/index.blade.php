...
@section('content')
    <div class="content-wrapper">
        ...
        <h3 class="page-title">All Dynamic Form Categories</h3>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="custon-table-header">
                        <h4 class="card-title">Dynamic Form Categories </h4>
                      ...
                      <table class="table table-bordered" id="category-table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-wrap">{{$cat->group->name ?? ''}}</td>
                            ...
                            <td class="classroom-btn" width="150">
                              ...
                              <form id="reset-form-{{$cat->id}}" action="/admin/dynamic-forms/categories/{{$cat->id}}/reset" method="POST" style="display: inline">
                                @csrf
