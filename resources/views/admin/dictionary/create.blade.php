...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Create Dictionary Content</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/admin/home') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ url('/admin/health-dictionary') }}"> Dictionary Content</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-header">Add Dictionary Content</div>
                    <div class="card-body">
                        <form method="POST" action="{{ ('/admin/health-dictionary') }}" enctype="multipart/form-data" class="forms-sample">
                            @csrf
