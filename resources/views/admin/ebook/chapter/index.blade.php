                            ...
                            <td>
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuOutlineButton1">
                                  <a href="/admin/ebook/books/{{$book->id}}/chapters/{{$chapter->id}}/files" class="text-primary dropdown-item">Files</a>
                                  <a href="/admin/ebook/books/{{$book->id}}/chapters/{{$chapter->id}}" class="text-info dropdown-item">Show</a>
                                  <a href="/admin/ebook/books/{{$book->id}}/chapters/{{$chapter->id}}/edit" class="text-danger dropdown-item">Edit</a>
                                    <form id="delete-form-{{$chapter->id}}" action="/admin/ebook/books/{{$book->id}}/chapters/{{$chapter->id}}" method="POST">
                                        @csrf
                                        @method('DELETE')
