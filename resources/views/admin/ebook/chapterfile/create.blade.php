    ...
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/admin/ebook/books/{{$book->id}}/chapters/{{$chapter->id}}/files">Chapters</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/admin/ebook/books/{{$book->id}}/chapters/{{$chapter->id}}/files" enctype="multipart/form-data" class="forms-sample">
                            @csrf
