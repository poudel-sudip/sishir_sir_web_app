                      ...
                      <div class="custon-table-header">
                          <h4 class="card-title">Latest 300 Video Bookings</h4>
                            <div class="text-right">
                                <a href="{{ ('/admin/video-booking/create') }}"><button type="button" class="btn btn-sm ml-3 btn-success"> Add Booking </button></a>
                            </div>
                      </div>
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td class="classroom-btn" width="150">
                                    <a href="/admin/video-booking/{{$booking->id}}" class="btn btn-primary">Show</a>
                                    @if(auth()->user()->permission>=40)
                                    <a href="/admin/video-booking/{{$booking->id}}/edit" class="btn btn-danger">Edit</a>
                                    <form id="delete-form-{{$booking->id}}" action="/admin/video-booking/{{$booking->id}}" method="POST" style="display: inline">
                                        @csrf
                                        @method('DELETE')
