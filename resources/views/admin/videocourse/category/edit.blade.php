...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Edit Video Category</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/admin/home') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ url('/admin/video-category') }}">Video Categories</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-header">Edit Video Category</div>
                  <div class="card-body">
                    <form class="forms-sample" method="POST" action="{{ ('/admin/video-category/'.$category->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
