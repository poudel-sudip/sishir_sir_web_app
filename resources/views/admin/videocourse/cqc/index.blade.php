...
@section('admin-title')
    Common Question Collections of {{$course->name}}
@endsection
...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('/admin/video-course') }}">Video Course</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="custon-table-header">
                            <h4 class="card-title">Common Question Collections of {{$course->name}}</h4>
                        </div>
                                ...
                                @foreach($cqcs as $cqc)
                                    <tr>
                                        ...
                                        <td class="classroom-btn" width="160">
                                            <form id="delete-form-{{$cqc->id}}" action="/admin/video-course/{{$course->id}}/cqc/{{$cqc->id}}" method="POST" style="display: inline">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="row">
            <div class="col-md-12">
                <hr>
                <form method="POST" action="/admin/video-course/{{$course->id}}/cqc" enctype="multipart/form-data">
                    @csrf
