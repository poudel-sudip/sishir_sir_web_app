...
@section('admin-title')
    Create PDF Bank Category
@endsection

@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Create PDF Bank Category</h3>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 grid-margin stretch-card">
                <div class="card">
                    <div class="card-header">Add PDF Bank Category</div>
                  <div class="card-body">
                    <form class="forms-sample" method="POST" action="{{ ('/admin/pdf-bank/categories') }}" enctype="multipart/form-data">
                        @csrf
