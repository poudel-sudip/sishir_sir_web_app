                            ...
                            <td width="50">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuOutlineButton1">
                                        <a href="/admin/pdf-bank/pdf-groups/{{$row->id}}" class="text-primary dropdown-item">Show</a>
                                        <a href="/admin/pdf-bank/pdf-groups/{{$row->id}}/edit" class="text-danger dropdown-item">Edit</a>
                                        <form id="delete-form-{{$row->id}}" action="/admin/pdf-bank/pdf-groups/{{$row->id}}" method="POST">
                                            @csrf
                                            @method('DELETE')
