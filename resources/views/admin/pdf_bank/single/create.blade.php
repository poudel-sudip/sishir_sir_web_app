                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ ('/admin/pdf-bank/pdf-singles') }}" enctype="multipart/form-data" class="forms-sample">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="pages" type="text" class="form-control @error('pages') is-invalid @enderror" name="pages" value="{{ old('pages') }}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="paper" type="text" class="form-control @error('paper') is-invalid @enderror" name="paper" value="{{ old('paper') }}" >
