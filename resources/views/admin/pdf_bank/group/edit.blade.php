...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Edit eBook</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/admin/home') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ url('/admin/pdf-bank/pdf-groups') }}">eBooks</a></li>
                <li class="breadcrumb-item active" aria-current="page">Edit eBook </li>
                </ol>
            </nav>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-10 grid-margin stretch-card">
                <div class="card">
                    <div class="card-header">Edit eBook</div>
                    <div class="card-body">
                        <form method="POST" action="/admin/pdf-bank/pdf-groups/{{$group->id}}" enctype="multipart/form-data" class="forms-sample">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="pages" type="text" class="form-control @error('pages') is-invalid @enderror" name="pages" value="{{ old('pages') ?? $group->pages }}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="paper" type="text" class="form-control @error('paper') is-invalid @enderror" name="paper" value="{{ old('paper') ?? $group->paper }}" >
