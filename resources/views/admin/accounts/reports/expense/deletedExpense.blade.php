...
@section('admin-title')
    Deleted Expense Lists
@endsection

@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Deleted Expenses</h3>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="custon-table-header">
                            <h4 class="card-title">Deleted Expense Lists</h4>
                        </div>
                                ...
                                @foreach($data as $row)
                                    <tr>
                                        ...
                                        <td class="classroom-btn" width="150">
                                            <form id="restore-form-{{$row->id}}" action="/admin/accounts/reports/expenses/deleted/{{$row->id}}" method="POST" style="display: inline">
                                                @csrf
                                                @method('PATCH')
