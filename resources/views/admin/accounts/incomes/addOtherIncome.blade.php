...
@section('admin-title')
    Add Other Office Income
@endsection

@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Add Office Incomes</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/admin/home') }}">Dashboard</a></li>
                    <li class="breadcrumb-item" aria-current="page">Accounts</li>
                    <li class="breadcrumb-item"><a href="{{ url('/admin/accounts/incomes') }}">Incomes</a></li>
                    <li class="breadcrumb-item" aria-current="page">Office Income</li>
        ...
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                    <form method="POST" action="/admin/accounts/incomes/others" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="category" class="col-md-4 col-form-label">{{ __('Income Category') }}</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                <label for="ledger_name" class="col-md-4 col-form-label">{{ __('Ledger Name (From)') }}</label>

                                <div class="col-md-8">
                                    <input id="ledger_name" type="text" class="form-control @error('ledger_name') is-invalid @enderror" name="ledger_name" value="{{ old('ledger_name') }}" >
                                    @error('ledger_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
