...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Add Course Incomes</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page">Course Income</li>
        ...
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                    <form method="POST" action="/admin/accounts/incomes/courses" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="userid" class="col-md-4 col-form-label">{{ __('Student ID') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="outof" class="col-md-4 col-form-label">{{ __('Out Of (Rs)') }}</label>

                                <div class="col-md-8">
                                    <input id="outof" type="text" class="form-control @error('outof') is-invalid @enderror" name="outof" value="{{ old('outof') }}"  >
