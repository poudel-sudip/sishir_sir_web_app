...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Add Staff Salary</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page">Staff Salary</li>
        ...
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                    <form method="POST" action="/admin/accounts/expenses/staff" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label">{{ __('Staff Full Name') }}</label>
