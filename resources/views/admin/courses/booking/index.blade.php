...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Latest Course Bookings</h3>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="custon-table-header">
                            <h4 class="card-title">Latest Course Bookings</h4>
                            <div class="text-right">
                                <a href="{{ ('/admin/course-bookings/create') }}"><button type="button" class="btn btn-sm ml-3 btn-success"> Add Booking </button></a>
                            </div>
                        </div>
