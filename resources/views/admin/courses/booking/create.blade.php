        ...
        <div class="row justify-content-center">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/admin/course-bookings" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="expiry_days" type="number" class="form-control @error('expiry_days') is-invalid @enderror" name="expiry_days" value="{{ old('expiry_days') }}">
