    ...
    <div class="content-wrapper">
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="{{ url('/admin/course-bookings') }}">Course Bookings</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-header">Edit Course Booking </div>
                    <div class="card-body">
                        <form method="POST" action="/admin/course-bookings/{{$booking->id}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="student" type="text" class="form-control @error('student') is-invalid @enderror" name="student" value="{{optional($booking->user)->name .' | '. optional($booking->user)->contact ?? ''}}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                        <select name="course_name" id="course_name" class="form-control @error('course_name') is-invalid @enderror" value="{{ old('course_name') }}" autofocus required>
                                            <option value="{{optional(optional($booking->batch)->course)->id}}">{{optional(optional($booking->batch)->course)->name}}</option>
                                            <option value="">---------</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select name="batch_name" id="batch_name" class="form-control @error('batch_name') is-invalid @enderror" value="{{ old('batch_name') }}"  required>
                                        <option value="{{optional($booking->batch)->id}}">{{optional($booking->batch)->name}}</option>
                                    </select>
                                    @error('batch_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <label class="">Out of Rs. {{((optional($booking->batch)->fee)-(optional($booking->batch)->discount))}} </label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="file" id="uploadDocument" name="uploadDocument" class="d-none" accept="image/*">
                            ...
                            <div class="form-group row">
                                <label for="expiry_days" class="col-md-4 col-form-label">{{ __('Expiry Days') }}</label>

                                <div class="col-md-8">
                                    <input id="expiry_days" type="number" class="form-control @error('expiry_days') is-invalid @enderror" name="expiry_days" value="{{ old('expiry_days') ?? $booking->expiry_days }}">
    ...
    <script>
        $(document).ready(function () 
        {
            ...
            function get_batches(id)
            {
                ...
                request.open('GET', '/admin/courses/'+id+'/batchnames', true)
                request.onload = function () {
                    ...
                    if (request.status >= 200 && request.status < 400) {
                        ...
                        batches.forEach((batch) => {
                            op += '<option value="' + batch.id + '">' + batch.name + ' @ Rs '+ (batch.fee-batch.discount) +'</option>';
                        });
                        // console.log(op);
