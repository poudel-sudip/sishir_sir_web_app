  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-header">Add New Course  Batch</div>
          <div class="card-body">
            <form class="form-sample" method="POST" action="/admin/courses/{{$course->id}}/batches" enctype="multipart/form-data">
              @csrf
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group row">
                    <label for="discount" class="col-sm-4 col-form-label"> Discount (Rs.)</label>
                    <div class="col-sm-8">
