                ...
                <div class="card-body">
                  <div class="custon-table-header">
                      ...
                      <div class="text-right">
                        <a href="/admin/dynamic-forms/{{$vform->id}}/applicants/export"><button type="button" class="btn btn-sm ml-3 btn-info"> Download Applicants </button></a>
                        {{-- <a href="/admin/dynamic-forms/{{$vform->id}}/applicants/upload"><button type="button" class="btn btn-sm ml-3 btn-success"> Upload Applicants </button></a> --}}
                      </div>
                  </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="h3 card-title text-center">Filter Data By Sub Course/Category</div>
                    <form method="POST" action="/admin/dynamic-forms/{{$vform->id}}/applicants/filter" enctype="multipart/form-data">
                      @csrf
