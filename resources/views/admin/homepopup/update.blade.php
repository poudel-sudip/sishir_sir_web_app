...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Edit Popup</h3>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/admin/home-popup/{{$popup->id}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            ...
                            {{-- <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="link" type="text" class="form-control @error('link') is-invalid @enderror" name="link" value="{{ old('link') ?? $popup->link }}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select id="status" class="form-control @error('status') is-invalid @enderror" name="status" value="{{ old('status') ?? $popup->status }}" required>
                                        <option value="{{$popup->status}}">{{$popup->status}}</option>
                                        <option value=""></option>
