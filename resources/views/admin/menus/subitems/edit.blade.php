                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="forms-sample" method="POST" action="/admin/menus/{{$group->id}}/sub-groups/{{$subgroup->id}}/categories/{{$category->id}}/items/{{$item->id}}/sub-items/{{$subitem->id}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="pdf_file" class="col-sm-4 col-form-label">{{ __('Sub Item File') }}</label>
                            <div class="col-md-8">
                            ...
                            <div class="col-md-8 row">
                                <div class="col-sm-4">
                                    <div class="form-check">
                                        ...
                                        <input id="membershipRadios1" type="radio" class="form-check-input" name="can_download" value="1" @if($subitem->download) checked @endif >Yes</label>
                                    </div>
                                </div>
                                <div class="col-sm-5">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                        <input id="membershipRadios2" type="radio" class="form-check-input" name="can_download" value="0" @if(!$subitem->download) checked @endif>No</label>
                                    </div>
                                </div>
                                @error('can_download')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="author" type="text" class="form-control @error('author') is-invalid @enderror" name="author" value="{{ old('author') ?? $subitem->author ?? auth()->user()->name }}" autocomplete="author">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="search_tags" type="text" class="form-control @error('search_tags') is-invalid @enderror" name="search_tags" value="{{ old('search_tags') ?? $subitem->search_tags }}" autocomplete="search_tags">
