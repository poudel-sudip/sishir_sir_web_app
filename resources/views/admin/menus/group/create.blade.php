...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Create Menu Group</h3>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-header">Add Menu Group</div>
                  <div class="card-body">
                    <form class="forms-sample" method="POST" action="{{ ('/admin/menus') }}" enctype="multipart/form-data">
                        @csrf
