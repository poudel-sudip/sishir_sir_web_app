...
@section('content')
  <div class="content-wrapper">
    ...
    <div class="text-center">
      <a href="{{ ('/admin/web-pages/about') }}"><button type="button" class="btn btn-sm ml-3 btn-outline-primary active"> About Page </button></a>
          ...
          <div class="card-body">
            <div class="custon-table-header">
              ...
              <div class="text-right">
                <a href="/admin/web-pages/about/edit"><button type="button" class="btn btn-sm ml-3 btn-warning"> Edit Page </button></a>
              </div>
            </div> 
            <hr>
            <div class="">
