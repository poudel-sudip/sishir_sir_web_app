...
@section('admin-title')
    E-Books | {{$publisher->name}}
@endsection

@section('content')
    <div class="content-wrapper">
        <div class="page-header">
        <h3 class="page-title">{{$publisher->name}} | E-Books</h3>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="custon-table-header">
                        <h4 class="card-title">{{$publisher->name}} | E-Books Lists</h4>
                            ...
                            <td>
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuOutlineButton1">
                                    <a href="/admin/publishers/{{$publisher->id}}/books/{{$row->id}}" class="text-primary dropdown-item">Show</a>
                                    <form id="delete-form-{{$row->id}}" action="/admin/publishers/{{$publisher->id}}/books/{{$row->id}}" method="POST">
                                        @csrf
                                        @method('DELETE')
