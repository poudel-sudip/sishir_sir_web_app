...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Create Publisher</h3>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/admin/publishers" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="parthership_value" type="text" class="form-control @error('parthership_value') is-invalid @enderror" name="parthership_value" value="{{ old('parthership_value') }}" autocomplete="parthership_value" >
