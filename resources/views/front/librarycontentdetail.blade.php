    ...
    <div class="container-fluid px-md-5">
        ...
        <div class="blog-container ">
            ...
            <div class="mt-3">
                ...
                <span class="mx-2 text-nowrap text-primary">
                    ...
                    @if($material->type == 'file' && $material->download)
                        <a href="{{url('/storage/'.$material->fileurl)}}" filename="{{($material->name)}}" onclick="handleDownload(event)" target="_blank" class="text-primary"> Download <i class="fa fa-file-pdf text-danger"></i> ({{ $material->size ?? 'undefined' }}) </a>
                    @endif
                </span>
            </div>
            ...
            <div class="mt-3">
                ...
                <div><strong>Source: </strong> <a @if(trim($material->source)) href="{{$material->source}}" target="_blank" @endif> {{$material->source}} </a> </div>
