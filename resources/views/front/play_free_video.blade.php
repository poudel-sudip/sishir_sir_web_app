    ...
    <div class="container-fluid px-md-5">
        <div class="row">
            <div class="col-md-12 etutor-breadcrumb text-center">
                <div class="text-center">
                    <h3 class="dchl-title fs-3">{{($video->title)}}</h3>
                </div>
        ...
        <div class="container-fluid  ebook-section " style="background: transparent;">     
            ...
            <div class="ebook-page-details " style="height: 100%">
                <div class="text-end mx-5 mb-3"><span class="mx-2 text-info"><i class="fa fa-eye"></i> {{$counterData->page_view_count ?? '1'}}</span></div> 
                <div class="w-100">
                    <iframe
                        id="video_iframe"
