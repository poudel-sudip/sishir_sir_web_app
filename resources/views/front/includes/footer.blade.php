...
<section class="footer-imp-link mt-5 mb-1">
  <div class="container-fluid">
    <div class="relative">
      <h2 class="home-section-heading">Important Links</h2>
    </div>
    {{-- <nav>
    ...
    <div class="row">
      <div class="col-12 col-md-6 col-lg-4">
        <ul class="footer-menu row">
          <li class="col-12 col-sm-6"><a href="/about-us">About Us</a></li>
          <li class="col-12 col-sm-6"><a href="/bmi-calculator">BMI Calculator</a></li>
          <li class="col-12 col-sm-6"><a href="/child-nutrition-calculator">Child Nutrition Calculator</a></li>
          <li class="col-12 col-sm-6"><a href="/health-ingos">Health INGOs in Nepal</a></li>
          <li class="col-12 col-sm-6"><a href="/palika-bibaran">Palika Bibaran in Nepal</a></li>
          ...
          <li class="col-12 col-sm-6"><a href="/question-of-the-day-quiz">Play Quiz</a></li>
          <li class="col-12 col-sm-6"><a href="/play-puzzle">Play Puzzle</a></li>
          <li class="col-12 col-sm-6"><a href="/know-the-picture">Know the Picture</a></li>
          <li class="col-12 col-sm-6"><a href="/discussion-forum">Discussion Forum</a></li>
          <li class="col-12 col-sm-6"><a href="/faqs">FAQs</a></li>
          <li class="col-12 col-sm-6"><a href="/web-policy">Web Policy</a></li>
        </ul>
        <hr>
      </div>
      <div class="col-12 col-md-6 col-lg-4">
        <h5 class="">Info & Support </h5>
        ...
        <div class="footer-card-list d-flex align-items-center flex-wrap gap-2">
          <li><a href="//esewa.com.np" target="_blank"><img class="img img-fluid rounded" src="{{ asset('images/card1.jpg') }}" alt="card esewa"></a></li>
          <li><a href="//fonepay.com" target="_blank"><img class="img img-fluid rounded" src="{{ asset('images/card5.jpg') }}" alt="card fone pay"></a></li>
          <li><a href="//nchl.com.np/" target="_blank"><img class="img img-fluid rounded" src="{{ asset('images/card8.jpg') }}" alt="card nepal pay"></a></li>
        </div>
        <hr>
      </div>
      <div class="col-12 col-md-6 col-lg-4">
        ...
        <div class="footer-sosmed d-none d-md-block">
          <a class="facebook" href="https://www.facebook.com/Shisirkumaradhikari" target="_blank"><i class="fab fa-facebook-f"></i></a>
        ...
        <hr>
        <div id="youtube-channel-details" class="d-flex gap-3 align-items-center">   
          <div class="">
        ...
        <div class="fb-continer">
          <div class="fb-page" data-href="https://www.facebook.com/Shisirkumaradhikari" data-tabs="timeline" data-width="" data-height="70" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
