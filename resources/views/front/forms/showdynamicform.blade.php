                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body enroll_form">
                            <form action="/dynamic-forms/{{$vform->slug}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label for="sub_course" class="col-md-4 text-md-end col-form-label">{{ __('Course') }}</label>
                                ...
                                @if(isset($vform->name) && $vform->name)
                                    <div class="form-group row">
                                        <label for="element_name" class="col-md-4 text-md-end col-form-label">Name</label>
                                ...
                                @if(isset($vform->email) && $vform->email)
                                    <div class="form-group row">
                                        <label for="element_email" class="col-md-4 text-md-end col-form-label">Email</label>
                                ...
                                @if(isset($vform->contact) && $vform->contact)
                                    <div class="form-group row">
                                        <label for="element_contact" class="col-md-4 text-md-end col-form-label">Contact</label>
                                ...
                                @if(isset($vform->message) && $vform->message)
                                    <div class="form-group row">
                                        <label for="element_message" class="col-md-4 text-md-end col-form-label">Message</label>
