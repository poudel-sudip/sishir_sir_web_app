...
@section('page_title',  $selected_course->name ?? 'Online Courses')
@section('og-title', $selected_course->name ?? 'Online Courses')
@section('og-url', url('/courses/category/'.$selected_course->id ?? ''))
        ...
        <div class="row">
            <div class="col-md-12 etutor-breadcrumb text-center">
                <div class="text-center">
                    <h3 class="dchl-title fs-3"> {{$selected_course->name ?? 'Online Courses'}} </h3>
                </div>
                <div aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{$selected_course->name}}</li>
                        @else
