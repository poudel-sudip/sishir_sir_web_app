    ...
    <div class="container-fluid px-md-5">
        ...
        @if($subMenu->type != 'heading')
            <div class="blog-container">
                <h3 class="text-primary text-center">{{($subMenu->name)}}</h3>
                <div class="mt-3">
                    <span class="mx-2 text-primary"><i class="fa fa-calendar-alt"></i> {{$subMenu->created_at->format('d M, Y, h:i A')}}</span>
                ...
                <div class="my-4 row align-items-center justify-content-end">
        ...
        @else
            <div class="table-responsive table-responsive-md ">
                <table class="table table-bordered asc-data-table table-hover table-striped border-primary">
                    ...
                    <?php 
                        $menuCategories = $subMenu->categories()->where('status','=','Active')->orderBy('order')->orderByDesc('id')->get(['id','name','slug']); 
                        $i = 1;
                    ?>
                    <tbody>
