        ...
        <div class="row">
            <div class="col-md-12 etutor-breadcrumb text-center">
                <div class="text-center">
                    <h3 class="dchl-title fs-3">Question Of The Day</h3>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="text-end mb-2">
                                    ...
                                    <span class="mx-2 text-success"><i class="fa fa-comments"></i> {{$today_question->comments()->count() ?? '0'}}</span>
                                    <span class="mx-2 text-info"><i class="fa fa-eye"></i> {{$counterData->page_view_count ?? '1'}}</span>
                                    <span class="mx-2 text-danger"><i class="fa fa-share"></i> {{$counterData->page_share_count ?? '1'}}</span>
                                </div>
                                <div class="text-center">
