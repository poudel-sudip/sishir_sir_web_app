        ...
        <div class="row">
            <div class="col-md-12 etutor-breadcrumb text-center">
                <div class="text-center">
                    <h3 class="dchl-title fs-3"> {{($selected_category->name)}} </h3>
                </div>
                    ...
                    <div class="swiper category-swiper nav nav-tabs"> 
                        <div class="swiper-wrapper">
                            ...
                            @foreach($blog_categories as $cat)
                                <div class="swiper-slide">
                                    <a href="/newsroom-category/{{$cat->id}}"> <button class="nav-link border {{$cat->id == $selected_category->id ? 'active' : ''}}">{{$cat->name}}</button> </a>
                                </div>
                            @endforeach
                        </div>
                    </div>
